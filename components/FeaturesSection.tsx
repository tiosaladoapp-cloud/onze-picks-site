const FEATURES = [
  ...
  { icon: '📊', title: 'Tracker de apuestas', desc: 'Registra tus apuestas reales, sigue tu P&L y exporta tu historial en CSV para análisis avanzado.' },
  ...
  { icon: '🏆', title: 'Ranking de grupos', desc: 'Compite con amigos guardando picks. El ranking se actualiza con los resultados reales.' },
    ...
    <section className="py-16 px-4 bg-[#0d0d0d]">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-black text-white mb-3">Todo lo que necesitas para apostar mejor</h2>
